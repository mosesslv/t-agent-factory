...
6. Produce the narrowest useful answer or artifact.
7. If the decision changes product direction, add or update a Product Decision / ADR.
8. If the decision changes acceptance, add or update eval coverage.
9. If the topic is not yet ready for formal artifacts, place it in the review queue.
